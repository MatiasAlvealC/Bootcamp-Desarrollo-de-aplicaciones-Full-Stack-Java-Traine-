		...
		<div class="container px-4 px-lg-5 mt-5">
			<div class="row g-3">
				...
				<div class="col-12">
						...
						<div class="col-6">
								<label for="numeracion">Numeración:</label> <input type="text"
			...
			<div class="col-12">
			<button type="submit" value="registrarNewUsuario"
			onclick="document.getElementById('action').value='registrarNewUsuario';">Registrar</button>
			</div>
						</div>
